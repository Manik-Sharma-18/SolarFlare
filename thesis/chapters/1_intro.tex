...
where flares originate. Existing work that uses winding reduces the map to a
single number---its spatial integral---before forecasting. This integration is
...
can a spatiotemporal deep model predict how the field evolves?} A model that can
anticipate the field's evolution has, in effect, learned the structure and
dynamics that a downstream forecaster would need. The vehicle for this study is
