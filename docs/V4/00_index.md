...
| [`04_experiments_and_state.md`](04_experiments_and_state.md) | v2.0 → v3.0 phase history, v3.0 vs v2.0 MIXED verdict numbers, metrics tracked, decisions, **11-arm ablation matrix (configs/ablations/)**, **V5 outputs archive pointer**, known concerns. |
